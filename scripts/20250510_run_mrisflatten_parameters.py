...
INPUT_PATCH_FILE_NAME = "lh.REDACTED_SUBJ_autoflatten.patch.3d"
...
if __name__ == "__main__":
    ...
    for i, scenario in enumerate(test_scenarios):
        ...
        output_name_prefix = os.path.join(
            SINGLE_OUTPUT_DIR,
            f"{input_file_basename_for_output}_{scenario_name_slug}",  # e.g., .../lh.REDACTED_SUBJ_autoflatten_FS6_UserTypical
        )
        ...
        try:
            with open(log_file_path, "w") as log_file:
                ...
                result = run_mris_flatten(
                    subject="REDACTED_SUBJ",  # or set appropriately if subject is known
                    hemi=HEMI,
